...
func set_available_players_list():
	...
	for new_player in Data._save.players:
		...
		new_card.get_node("HBoxContainer/StrengthLabel").text = str(new_player.strength)
		new_card.get_node("HBoxContainer/AgilityLabel").text = str(new_player.agility)
		new_card.get_node("HBoxContainer/EnduranceLabel").text = str(new_player.endurance)
		new_card.get_node("HBoxContainer/IntelligenceLabel").text = str(new_player.intelligence)
		new_card.get_node("HBoxContainer/CharismaLabel").text = str(new_player.charisma)
